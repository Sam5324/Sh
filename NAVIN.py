...
# Configuration
TOKEN = "7520785773:AAHnbnZZk_jISTHAabZdm8LGgJxUu3pMpyY"  # Replace with your Telegram bot token
ADMIN_IDS = {6114033856}  # Replace with your actual admin user ID(s)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_data is None or user_data.get("expiration_date") < datetime.now():
        await update.message.reply_text("You are not authorized to use this bot buy from @nomore231.")
        return
